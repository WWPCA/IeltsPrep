...
def create_lambda_with_dynamodb():
    """Create Lambda function that uses DynamoDB for questions"""
...
def call_nova_micro_api(prompt: str, assessment_type: str) -> Dict[str, Any]:
    ...
    assessment_result = {
        ...
        "criteria": {
            "task_achievement": {"score": random.uniform(6.0, 8.0), "feedback": "Good task response with clear position and relevant examples."},
            "coherence_cohesion": {"score": random.uniform(6.5, 8.0), "feedback": "Well-organized ideas with appropriate linking devices."},
            "lexical_resource": {"score": random.uniform(6.0, 7.5), "feedback": "Good range of vocabulary with some sophisticated usage."},
            "grammatical_range": {"score": random.uniform(6.5, 8.0), "feedback": "Variety of sentence structures with good accuracy."}
        },
        ...
        document.getElementById('login-form').addEventListener('submit', function(e) {{
            ...
            if email in users:
                ...
                if stored_hash == input_hash:
                    ...
                    return {
                        "statusCode": 302,
                        "headers": {"Location": "/dashboard", "Set-Cookie": cookie_value},
                        "body": ""
                    }
...
<body>
    <div class="container py-5">
        <div class="row justify-content-center">
            ...
            if "writing" in assessment_type:
                # Writing assessment page with DynamoDB question
...
<body>
    ...
    <script>
        ...
        updateTimer();
                ...
                # Speaking assessment page with Maya integration and DynamoDB question
...
<body>
    ...
    <script>
        ...
        console.log('WebSocket URL:', '{maya_session.get("websocket_url", "N/A")}');
            ...
            # Simplified profile implementation
            return {
                "statusCode": 200,
                "headers": {"Content-Type": "text/html"},
                "body": """<!DOCTYPE html>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Profile functionality with DynamoDB question tracking.</p>
...
if __name__ == "__main__":
    print("🚀 DEPLOYING DYNAMODB QUESTION SYSTEM")
    print("=" * 50)
    
    # Step 1: Populate questions in DynamoDB
    if populate_questions_table():
        # Step 2: Create and deploy Lambda with DynamoDB integration
        lambda_code = create_lambda_with_dynamodb()
        ...
        try:
            ...
            print('  ✅ Dynamic question loading with fallback support')
            print('  ✅ Easy to add new questions without code deployment')
            print('  ✅ Better scalability for large question banks')
            print('  ✅ Question versioning and management capabilities')
            print('')
            ...
            print('  • Profile page indicates "Question Source: DynamoDB"')
            print('')
        ...
        print("❌ Failed to populate questions in DynamoDB")
