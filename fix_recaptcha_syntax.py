#!/usr/bin/env python3
"""
Fix reCAPTCHA syntax error and deploy corrected version
Resolves f-string syntax error in JavaScript code
"""
...
def create_lambda_with_fixed_syntax():
    """Create Lambda function with fixed syntax (no f-string issues)"""
    ...
    # Create Lambda function code with fixed syntax
    lambda_code = '''
"""
AWS Lambda Handler for IELTS GenAI Prep with Fixed reCAPTCHA Integration
Fixed syntax errors in JavaScript code within Python f-strings
"""
...
def lambda_handler(event, context):
    """Main AWS Lambda handler with fixed reCAPTCHA"""
...
def deploy_fixed_syntax():
    """Deploy Lambda function with fixed syntax"""
    
    # Create Lambda function code
    lambda_code = create_lambda_with_fixed_syntax()
    ...
    try:
        ...
        print("✓ Fixed syntax error and deployed successfully!")
        print(f"Function ARN: {response['FunctionArn']}")
        print(f"Last Modified: {response['LastModified']}")
        print(f"Version: {response['Version']}")
        print(f"Production URL: https://www.ieltsaiprep.com")
        print("\n🔧 Fixed Issues:")
        print("  • Resolved f-string syntax error in JavaScript code")
        print("  • Fixed reCAPTCHA site key interpolation")
        print("  • Restored modern 'On User Interaction' reCAPTCHA")
        ...
        print(f"✗ Error deploying fixed version: {str(e)}")
        # Clean up
