...
def deploy_correct_template():
    # Create the working Lambda code with the approved comprehensive template
...
def handle_home_page():
    return {
        ...
        'body': get_comprehensive_template()
    }
...
def get_comprehensive_template():
    # The exact comprehensive template that was approved and working
...
<head>
    ...
    <meta name="description" content="Master IELTS with AI-powered practice using Amazon Nova technology. Get personalized feedback on writing and speaking skills from our advanced AI examiner.">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.0/font/bootstrap-icons.css" rel="stylesheet">
    <style>
        :root {
            --primary-color: rgb(67, 97, 238);
            --secondary-color: rgb(54, 81, 212);
        ...
        .mobile-cta {
            background: linear-gradient(135deg, var(--success-color) 0%, rgb(39, 174, 96) 100%);
            color: white;
            padding: 60px 0;
            margin: 80px 0;
        }
...
'''
    ...
    with zipfile.ZipFile('correct-template.zip', 'w', zipfile.ZIP_DEFLATED) as zip_file:
        zip_file.writestr('lambda_function.py', lambda_code)

    # Deploy to Lambda
    lambda_client = boto3.client('lambda', region_name='us-east-1')

    with open('correct-template.zip', 'rb') as f:
        zip_content = f.read()

    print('Deploying correct comprehensive template...')
    ...
    print('Correct template deployed successfully!')

if __name__ == "__main__":
    deploy_correct_template()