#!/usr/bin/env python3
"""
Deploy updated template removing inaccurate "Trusted by 30,000+ test-takers" line
Maintains all other functionality while removing false claim
"""
...
def create_lambda_with_corrected_template():
    """Create Lambda function with corrected template (no false claims)"""
    
    # Read the corrected template
    with open('working_template.html', 'r') as f:
        template = f.read()
    
    # Create Lambda function code with corrected template
    lambda_code = '''
"""
AWS Lambda Handler for IELTS GenAI Prep with Corrected Template
Removed inaccurate "Trusted by 30,000+ test-takers" line
"""
...
def lambda_handler(event, context):
    """Main AWS Lambda handler with corrected template"""
...
def handle_home_page() -> Dict[str, Any]:
    """Handle home page with corrected template (no false claims)"""
...
def deploy_corrected_template():
    """Deploy Lambda function with corrected template"""
    
    # Create Lambda function code
    lambda_code = create_lambda_with_corrected_template()
    ...
    try:
        ...
        print("✓ Corrected template deployed successfully!")
        print(f"Function ARN: {response['FunctionArn']}")
        print(f"Last Modified: {response['LastModified']}")
        print(f"Version: {response['Version']}")
        print(f"Production URL: https://www.ieltsaiprep.com")
        print("\n🔧 Changes made:")
        print("  • Removed inaccurate 'Trusted by 30,000+ test-takers' line")
        print("  • Maintained all existing functionality and design")
        print("  • Preserved authentic assessment sample structure")
        print("  • Kept working reCAPTCHA integration")
        print("  • No other content or functionality affected")
        ...
        print(f"✗ Error deploying corrected template: {str(e)}")
        # Clean up
