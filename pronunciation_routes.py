"""
Routes for the pronunciation coach feature of the IELTS preparation app
"""
import os
import json
import uuid
...
from app import app
from aws_services import transcribe_audio, generate_polly_speech, analyze_pronunciation, generate_pronunciation_exercises
...
def ensure_dirs_exist():
    ...
    tts_dir = os.path.join(app.root_path, 'static', 'audio', 'tts')
