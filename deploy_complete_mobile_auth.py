#!/usr/bin/env python3
"""
Deploy complete mobile authentication workflow - Fixed version
"""
...
def create_production_lambda():
    """Create production Lambda with mobile auth workflow"""
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Mobile Registration - IELTS GenAI Prep</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-4">
        <div class="card">
            <div class="card-header bg-success text-white">
                ...
                <p class="mb-0">Complete your registration after App Store/Google Play purchase</p>
            </div>
            <div class="card-body">
    ...
    <script>
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            // Simulate purchase data from mobile app
            const purchaseData = {
                productId: 'ielts_assessment_4pack',
                platform: 'apple',
            ...
            .then(data => {
                if (data.success) {
                    alert('Registration successful! Welcome to IELTS GenAI Prep.');
...
<body>
    <div class="container mt-4">
        <h1>Dashboard</h1>
        <p>Welcome to IELTS GenAI Prep - $36.49 USD for 4 assessments</p>
...
<body>
    <div class="container mt-4">
        ...
        <div class="alert alert-info">
            ...
            <p>Pricing: $36.49 USD for 4 assessments</p>
        </div>
...
def handle_health_check():
    ...
    return {
        ...
        'body': json.dumps({
            ...
            'pricing': '$36.49 USD for 4 assessments'
        })
    }
'''
