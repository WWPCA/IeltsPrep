...
# Fixed Lambda code - remove test credentials and fix reCAPTCHA
lambda_code = '''
import json
import hashlib
import secrets
...
def verify_recaptcha_v2(recaptcha_response: str, user_ip: Optional[str] = None) -> bool:
    """Verify reCAPTCHA v2 response with Google using enhanced verification"""
...
try:
    ...
    print('✅ PRODUCTION LOGIN FIXED!')
    print(f'Function ARN: {response["FunctionArn"]}')
    print('Production URL: https://www.ieltsaiprep.com')
    print('')
    print('🔧 Changes Applied:')
    print('  • Removed test credentials display from login page')
    print('  • Changed reCAPTCHA script to standard API (not enterprise)')
    print('  • Added proper placeholder text for form fields')
    print('  • Maintained enhanced verification process')
    print('  • Professional clean login interface')
    print('')
    print('✅ Test the fixed login:')
    print('  1. Visit: https://www.ieltsaiprep.com/login')
    print('  2. No test credentials should be visible')
    print('  3. reCAPTCHA should load without "Invalid site key" error')
    print('  4. Use actual credentials to test login functionality')
