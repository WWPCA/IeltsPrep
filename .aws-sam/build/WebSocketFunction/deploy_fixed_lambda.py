#!/usr/bin/env python3
"""
Deploy Lambda function with syntax error fixed
Corrects the JavaScript template string issue
"""
...
def create_fixed_lambda():
    """Create Lambda function with corrected JavaScript syntax"""
    ...
    # Create Lambda function code with fixed JavaScript
    lambda_code = f'''
"""
AWS Lambda Handler for IELTS GenAI Prep - Fixed JavaScript Syntax
Production-ready Lambda function with corrected assessment functionality
"""
...
def lambda_handler(event, context):
    """Main AWS Lambda handler with fixed syntax"""
...
def handle_assessment_page(assessment_type: str, headers: Dict[str, str]) -> Dict[str, Any]:
    ...
    # Build criteria badges HTML
    criteria_html = ""
    for criterion in config['criteria']:
        criteria_html += f'<span class="criteria-badge">{{criterion}}</span>'
...
def deploy_fixed_lambda():
    """Deploy Lambda function with fixed JavaScript syntax"""
    ...
    try:
        ...
        print("\n🔧 Syntax Issues Fixed:")
        print("  • Corrected JavaScript template string syntax")
        print("  • Fixed f-string formatting in assessment pages")
        print("  • Resolved malformed HTML generation")
        print("  • Enhanced error handling and logging")
        print("  • All assessment pages now render correctly")
        ...
        print(f"✗ Error deploying fixed Lambda: {str(e)}")
