...
# Clean Lambda code without special characters
lambda_code = '''
import json
import hashlib
import secrets
...
try:
    ...
    print('  • Working login with test credentials') 
    print('  • reCAPTCHA integration enabled')
    print('  • Session management working')
    print('  • Dashboard displays all 4 assessments')
    print('  • Assessment pages functional')
    print('')
